...
export function validateDisciplinaCsv(records) {
    ...
    const fieldRules = [
        ...
        {
            key: 'disciplina',
            requiredMsg: 'Informe o nome da disciplina.'
        },
        {
        ...
        {
            key: 'periodoCurricular',
            requiredMsg: 'Informe o período curricular da disciplina.'
        },
        {
            key: 'estado',
            requiredMsg: 'Informe o estado da disciplina.'
        },
        {
            key: 'campus',
            requiredMsg: 'Informe o campus.'
        }
    ];
